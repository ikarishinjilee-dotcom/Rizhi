<template>
	<img v-if="definition?.assetUrl" class="icon-glyph icon-glyph--image" :src="definition.assetUrl" :alt="definition.label" :style="style" />
...
<style scoped>
.icon-glyph { display: inline-flex; flex: 0 0 auto; align-items: center; justify-content: center; object-fit: contain; }
.icon-glyph--fallback { color: currentColor; font-size: 0.62em; font-weight: 700; line-height: 1; }
</style>
